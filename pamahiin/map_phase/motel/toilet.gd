...
const _DIALOGUE = preload("uid://dc8vmwm663ygj")


func _ready():
	$ToiletArea.body_entered.connect(_on_area_2d_body_entered)
	$ToiletArea.body_exited.connect(_on_area_2d_body_exited)
	pass
